...
int main()
{
    step("Create triangle1 and print its params:");
    ...
    step("Copy to triangle2 and change triangle1, print triangle2:");
    Triangle triangle2(triangle1);
    triangle1.SetSides(3, 4, 5);
    cout << "triangle1: " << triangle1.ToString() << endl;
    cout << "triangle2: " << triangle2.ToString() << endl;

    step("Create triangle3 with bad params, print triangle3, set correct params");
    Triangle triangle3;
